...
(function($PS) {
  ...
  var showTheme = new Data_Show.Show(function (v) {
  ...
  var optsInfo = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(optsParser)(Options_Applicative_Extra.helper))(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.fullDesc)(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.progDesc("Print a greeting for TARGET"))(Options_Applicative_Builder.header("mmdc - a test for purescript-optparse"))));
          ...
          return function (svg) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.newPage(browser))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Toppokki.setContent(indexHtml)(v))(function () {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.unsafePageEval("svg")("(svg) => { const react = svg.getBoundingClientRect(); return { x: react.left, y: react.top, width: react.width, height: react.height } }")(v))(function (v1) {
                          var clip = Foreign.unsafeFromForeign(v1);
  ...
  var main = function __do() {
      ...
      var v1 = (function () {
          var v1 = Node_Path.extname(output);
          if (v1 === ".svg") {
              return SVG.value;
          };
          if (v1 === ".png") {
      ...
      return Effect_Aff.launchAff_((function () {
          var headless = !v.debug;
          var doClose = !v.debug;
          return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(v.input))(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.launch()({
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(mermaidRender(v3)(v.theme)(v2))(function (v4) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 91, column 5 - line 93, column 48): " + [ v1.constructor.name ]);
                      })())(function () {
