...
Since [[https://github.com/mermaidjs/mermaid.cli][mermaidjs/mermaid.cli]] looks like it is not maintained anymore, re-written with purescript for my personal use.
